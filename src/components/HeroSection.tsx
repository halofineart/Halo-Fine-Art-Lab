...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="relative overflow-hidden bg-[#FAF8F5] pt-12 pb-20 border-b border-[#E8E2D5]/70">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Editorial Top Badge */}
        <div className="text-center max-w-4xl mx-auto mb-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full border border-[#D6CEBE]/80 bg-[#F4EFE6]/60 text-[#736B60] text-[10px] sm:text-[11px] uppercase tracking-[0.2em] font-medium mb-6">
            <Lock className="w-3 h-3 text-[#8C6D37]" />
            <span>Laboratorio de Encuadernación Artesanal</span>
          </div>

          {/* Main Editorial Headline */}
          <h1 className="font-serif-luxury text-4xl sm:text-6xl lg:text-[72px] font-normal text-[#1F1C18] tracking-tight leading-[1.08] mb-6">
            Tus recuerdos merecen<br className="hidden sm:inline" /> algo más que una pantalla.
          </h1>

          {/* Subtitle */}
          <p className="text-sm sm:text-base text-[#736B60] font-light leading-relaxed max-w-2xl mx-auto mb-8">
            Transformamos los momentos guardados en tu celular en fotolibros impresos en auténtico papel fotográfico químico Layflat con <span className="underline decoration-[#C5A059]/60 underline-offset-4 text-[#1F1C18] font-normal">tapas de lino natural grabadas en oro</span>. Hechos para durar generaciones.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 mb-8">
            <button
              ...
              className="w-full sm:w-auto px-8 py-3.5 rounded-none bg-[#1F1C18] text-[#FDFCF9] text-xs uppercase tracking-[0.18em] font-semibold hover:bg-[#3D352E] shadow-sm transition-all flex items-center justify-center gap-2.5 cursor-pointer"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto px-8 py-3.5 rounded-none border border-[#D6CEBE] bg-[#FDFCF9] text-[#1F1C18] text-xs uppercase tracking-[0.18em] font-medium hover:bg-[#F4EFE6] transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
        ...
        {/* Big Editorial Photo Mockup with Coffee Cup & Soft Ambient Setting */}
        ...
        <div id="how-it-works" className="mt-20 scroll-mt-24">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-xs tracking-[0.16em] uppercase text-[#8C8275] font-medium mt-2">
