      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <span className="text-xs sm:text-sm font-semibold tracking-[0.25em] text-[#C5A059] uppercase block">
            ...
            <p className="font-serif-luxury text-xl sm:text-2xl lg:text-3xl text-[#E3DAC9] italic font-light">
            ...
            {/* Micro Pillars */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-3 text-sm text-[#F0EBE1] font-light">
              <div className="flex items-center gap-3">
                <span className="w-2 h-2 rounded-full bg-[#ECC880]" />
            ...
            <div className="pt-5 flex flex-col sm:flex-row items-center gap-4">
              <button
                ...
                className="w-full sm:w-auto px-9 py-4 bg-[#ECC880] text-[#1F1C18] text-xs sm:text-sm uppercase tracking-[0.18em] font-semibold hover:bg-[#F2D79E] transition-all flex items-center justify-center gap-2.5 cursor-pointer shadow-xs"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto px-9 py-4 border border-[#8C8275] text-[#FDFCF9] text-xs sm:text-sm uppercase tracking-[0.18em] font-semibold hover:bg-white/10 transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
          ...
          <div className="lg:col-span-5">
            <div className="border border-white/10 bg-[#292521] p-4 sm:p-6 shadow-2xl">
              ...
              <div className="mt-4 pt-3.5 border-t border-white/10 flex items-center justify-between text-xs sm:text-sm text-[#D4CABE]">
                <span className="font-serif-luxury text-white">Lino Crudo & Grabado Oro</span>
                <span className="font-mono text-[#ECC880] font-medium">Producción Artesanal</span>
              </div>
            </div>
          </div>
